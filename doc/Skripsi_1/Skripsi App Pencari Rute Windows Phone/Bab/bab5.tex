...
% Gambar antarmuka kelas MainPage
	...
	\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.25]{Gambar/antarmuka/splash}
	...
	\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.25]{Gambar/antarmuka/list_main}
	...
	\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.25]{Gambar/antarmuka/map}
	...
	\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.25]{Gambar/antarmuka/wait_route}
	...
	\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.25]{Gambar/antarmuka/route_map}
...
Selain pengujian langsung penulis juga coba mambandingkan hasilnya pencarian di android dan di Windows Phone. Hasil perbandingan dapat dilihat pada gambar dibawah ini.
	...
	\hspace{0.5cm} Dari hasil perbandingan aplikasi pencarian rute pada Android dan Windows Phone penulis mendapatkan kesimpulan sebagi berikut.

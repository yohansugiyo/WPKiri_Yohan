...
\hspace{0.5cm} Merupakan Kelas yang dipakai untuk mengirim permintaan HTTP dan menerima kembalian HTTP dari \textit{Uniform Resource Identifier}(URI) yang dapat diidentifikasi. Berikut \textit{method} yang disediakan kelas \textit{HttpClient}.
\begin{itemize}
...
\begin{itemize}
	\item JsonConvert merupakan kelas yang berfungsi untuk konversi dari JSON String ke objek dan sebaliknya. Kelas ini memiliki dua buah \textit{method} yaitu SerializeObject() dan DeserializeObject().
